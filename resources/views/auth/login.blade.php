...
<body class="bg-gray-900">
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-12 bg-gray-900 lg:bg-gray-900 flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <svg class="w-10 text-indigo-300" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 225 225" style="enable-background:new 0 0 225 225;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: none;
                                    stroke: currentColor;
                    ...
                    <div class="text-2xl text-indigo-200 tracking-wide ml-2 font-semibold">TeFa</div>
                </div>
            </div>
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2 class="text-center text-4xl text-indigo-200 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">Log in</h2>
                <div class="mt-12">
                    <form method="POST" action="{{ url('api/login') }}">
                        @csrf
                        <div>
                            <div class="text-sm font-bold text-gray-200 tracking-wide">Email Address</div>
                            <input class="w-full px-5 py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" placeholder="name@gmail.com" id="email" name="email" value="{{ old('email') }}" required autofocus>
                        </div>
                        @error('email')
                        ...
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                                <div class="text-sm font-bold text-gray-200 tracking-wide">
                                    Password
                                </div>
                            </div>
                            <input class="w-full px-5 py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" id="password" name="password" placeholder="Enter your password">
                        </div>
                        @error('password')
                        <p class="mb-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
